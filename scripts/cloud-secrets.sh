...
# Apague este arquivo para rotacionar tudo no proximo 'make cloud-up'
# (que recria o cluster do zero, entao a rotacao e' segura).
JWT_SECRET=$jwt
ENCRYPTION_KEY=$enc
...
echo ">> guarde a senha do admin -- ela vive em $f."
